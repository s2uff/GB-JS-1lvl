class Board {
    ...
    /**
     * Является ли следующий шаг, шагом на тело змейки.
    ...
    isNextStepToBody(nextCellCoords) {
        ...
        for (let n = 1; n < this.snake.body.length; n++) {
            if (nextCellCoords.x === this.snake.body[n].x && nextCellCoords.y === this.snake.body[n].y) {
                return true;
            }
        }
    }
